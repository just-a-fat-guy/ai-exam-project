    ...
    <main className="flex flex-col min-h-screen bg-gray-900">
          ...
          <div className="px-4 py-3 bg-gray-800/90 border-t border-gray-700/50 animate-slide-down shadow-lg">
            ...
            <div className="space-y-3">
              <div>
                ...
                >
                  <option value="research_report">摘要报告：更快更简洁（约 2 分钟）</option>
                  <option value="deep">深度研究报告</option>
                  <option value="multi_agents">多 Agent 协作报告</option>
                  <option value="detailed_report">详细报告：更深入、更完整（约 5 分钟）</option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  <option value="Objective">客观：尽量中立、无偏地呈现事实</option>
                  <option value="Formal">正式：更贴近学术和专业写作风格</option>
                  <option value="Analytical">分析型：强调数据比较与逻辑推导</option>
                  <option value="Persuasive">说服型：突出观点表达与论证力度</option>
                  <option value="Informative">信息型：清晰全面地传达信息</option>
                  <option value="Simple">简明：用更基础的语言解释问题</option>
                  <option value="Casual">轻松：更口语化、更自然的表达</option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  <option value="copilot">Copilot：对话式布局</option>
                  <option value="document">Document：传统文档布局</option>
                </select>
              </div>
            </div>
          </div>
      ...
      <footer className="mt-auto py-3 px-4 text-center border-t border-gray-800/40 bg-gray-900/80 backdrop-blur-sm">
        ...
        <div className="text-xs text-gray-400">
          © {new Date().getFullYear()} GPT Researcher。保留所有权利。
        </div>
      </footer>
